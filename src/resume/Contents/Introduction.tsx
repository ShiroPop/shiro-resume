  ...
  return (
    <Container>
      ...
      <Grid>
        ...
        <Text fontSize="14px">
          개발자 15명과 1인 디자이너가 함께 작업을 할 때, 디자인 속도가 개발
          속도를 따라오지 못하여 업무가 밀린 상황이었습니다. 저는 디자이너님을
          도와
        ...
        <Text fontSize="14px">
          ...
          바꾸어도 괜찮은지 여쭙고 백엔드에 양해를 구하여 배열의 값이 수정될
          때마다 서버에 데이터를 저장하여 refetch로 값을 관리했습니다.{" "}
          <MText>
            '못하겠다'라는 말보다 다른 해결법을 찾아보고 주변에 의견을 구하여
            문제를 해결
          </MText>
          하고자 합니다.
        </Text>
        ...
        <Text fontSize="14px">
          ...
          수정 사항을 제시하며 많은 부분을 컴포넌트화하거나 문서화를
          담당했습니다. 조회 Table, Date Picker 등을 컴포넌트화하였으며, 에러
          문구 또한 따로 정리하여 문서화하는 작업을 진행했습니다. 이런 성격 덕에
          이전 직장에서 팀장님과 팀원들 사이에서{" "}
