  ...
  return (
    <Container>
      ...
      <Grid>
        ...
        <Text fontSize="14px">
          클리브웍스 프로젝트에서 15명의 개발자와 1인 디자이너가 함께 작업을 할
          때였습니다. 디자인 속도가 개발 속도를 따라오지 못하여 업무가 밀리게
          되었습니다. 저는 전공을 살려 디자이너님을 도와
          <MText> 디자인 시스템</MText>을 제안하며 일부 시스템을 제시하였습니다.
          뿐만 아니라 버튼이나 텍스트 필드와 같은 유사한 요소를 모아
